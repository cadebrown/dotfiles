...
# --- ~/.claude stays real; Codex is not scratch-managed ---
...
@test "scratch has no Codex migration path" {
    ! grep -q 'DF_CODEX_LINKS\|link_file_to_scratch\|_codex_in_use' "$HOME/dotfiles/install/scratch.sh"
}
