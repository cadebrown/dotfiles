...
| <a id="editors" href="#editors">VS Code & Cursor</a> | [VS Code settings](../../home/dot_config/vscode/settings.json), [Cursor settings](../../home/dot_config/cursor/), [Cursor harness](../../home/dot_cursor/) | config dirs, native User links, `.cursor/` | Extensions, Remote-SSH, GUI reload, MCP JSON, CLI merge (Composer 2.5 default), My Machines worker. See [Cursor](../agents/cursor.md). |
| <a id="agents" href="#agents">Agents</a> | [Codex](../../home/dot_codex/), [Claude](../../home/dot_claude/), [Cursor](../../home/dot_cursor/), [OpenCode](../../home/dot_config/opencode/), [Pi](../../home/dot_pi/) | .codex, .claude, .cursor, OpenCode, Pi dirs | Plugin caches, MCP processes, auth; [guides](../agents/README.md). |
