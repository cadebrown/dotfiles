...
| <a id="editors" href="#editors">VS Code & Cursor</a> | [VS Code settings](../../home/dot_config/vscode/settings.json), [Cursor settings](../../home/dot_config/cursor/), [Cursor harness](../../home/dot_cursor/) | config dirs, native User links, `.cursor/` | Extensions, Remote-SSH, GUI reload, MCP JSON, CLI merge, My Machines worker. See [Cursor](../agents/cursor.md). |
