...
- [PLAT isolation](setup/plat.md)
- [Auth (API tokens)](setup/auth.md)
- [Scratch space](setup/scratch.md)
- [Overlays](setup/overlays.md)
...
- [Durable Codex tasks](usage/durable-tasks.md)
- [Browser workspaces](usage/browser-sessions.md)
- [Google Cloud MCP credentials](usage/google-cloud-mcp.md)
...
- [Bootstrap flow](reference/bootstrap-flow.md)
