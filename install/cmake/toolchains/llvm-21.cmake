# llvm-21.cmake — Homebrew LLVM 21 toolchain for CMake
...
# Prefer the pinned opt/llvm@21 dir; fall back to the unversioned opt/llvm symlink
...
if(NOT IS_DIRECTORY "${_llvm}/bin")
    message(WARNING "llvm-21.cmake: LLVM 21 not found under ${_brew}/opt — toolchain inactive (HOMEBREW_PREFIX=$ENV{HOMEBREW_PREFIX})")
    unset(_llvm)
    unset(_brew)
    return()
endif()
