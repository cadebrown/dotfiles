...
set(CMAKE_C_COMPILER   "${_brew}/bin/gcc-13"        CACHE FILEPATH "")
set(CMAKE_CXX_COMPILER "${_brew}/bin/g++-13"        CACHE FILEPATH "")
set(CMAKE_AR           "${_brew}/bin/gcc-ar-13"     CACHE FILEPATH "")
set(CMAKE_RANLIB       "${_brew}/bin/gcc-ranlib-13" CACHE FILEPATH "")
...
if(EXISTS "$ENV{_LOCAL_PLAT}/.cuda/bin/nvcc")
    ...
    set(CMAKE_CUDA_HOST_COMPILER "${_brew}/bin/g++-13"              CACHE FILEPATH "")
endif()
