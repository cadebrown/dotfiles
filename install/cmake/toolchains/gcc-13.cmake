# gcc-13.cmake — Homebrew GCC 13 toolchain for CMake
# Installed per-PLAT by install/cmake.sh to $_LOCAL_PLAT/cmake/toolchains/.
#
# Switch to this:
#   CMAKE_TOOLCHAIN_FILE=$_LOCAL_PLAT/cmake/toolchains/gcc-13.cmake cmake ...
#
...
# Compilers
set(CMAKE_C_COMPILER         "${_brew}/bin/gcc-13"        CACHE FILEPATH "C compiler")
set(CMAKE_CXX_COMPILER       "${_brew}/bin/g++-13"        CACHE FILEPATH "C++ compiler")
set(CMAKE_ASM_COMPILER       "${_brew}/bin/gcc-13"        CACHE FILEPATH "ASM compiler")
...
set(CMAKE_AR                 "${_brew}/bin/gcc-ar-13"     CACHE FILEPATH "Archiver")
set(CMAKE_RANLIB             "${_brew}/bin/gcc-ranlib-13" CACHE FILEPATH "Ranlib")
set(CMAKE_NM                 "${_brew}/bin/gcc-nm-13"     CACHE FILEPATH "NM")
...
# CUDA host compiler
set(CMAKE_CUDA_HOST_COMPILER "${_brew}/bin/g++-13"        CACHE FILEPATH "CUDA host compiler")
...
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    if(CMAKE_VERSION VERSION_GREATER_EQUAL "3.29")
        ...
        find_program(_mold mold)
        if(_mold)
            set(CMAKE_EXE_LINKER_FLAGS_INIT    "-fuse-ld=mold" CACHE STRING "")
            set(CMAKE_SHARED_LINKER_FLAGS_INIT "-fuse-ld=mold" CACHE STRING "")
            set(CMAKE_MODULE_LINKER_FLAGS_INIT "-fuse-ld=mold" CACHE STRING "")
        elseif(EXISTS "${_brew}/opt/llvm/bin/lld")
